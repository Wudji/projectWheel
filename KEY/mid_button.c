...
void user_button_init(void)
{
    ...
    user_button[BUTTON_UP].pressed_logic_level = 0;
    ...
    user_button[BUTTON_LEFT].pressed_logic_level = 0;
    ...
    user_button[BUTTON_RIGHT].pressed_logic_level = 0;
    ...
    user_button[BUTTON_DOWN].pressed_logic_level = 0;
    /* 初始化 按键引脚 */
